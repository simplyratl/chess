...
const Square = ({children, white, index, player, selectedFigure, position}: Props) => {
	...
	return (
		<div
			className={`relative w-full h-full ${background} transition-colors duration-500`}
			// onClick={() => setSelectedFigure(position)}
		>
			{children}
			<span
