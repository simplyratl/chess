...
const Register = () => {
	...
	const handleSubmit = async (e: any): Promise<void> => {
		...
		if (!username || !password || !confirm_password || !email)
			returnError("You have to type in all inputs.");
		if (password !== confirm_password) returnError("Passwords don't match.");
				...
				>
					<div className="relative flex justify-center items-center w-[420px] h-full py-8 sm:p-4 sm:w-full">
						<div className="w-full h-full flex flex-col justify-center items-center">
							...
							<div
								className="max-w-96 w-full sm:w-full mt-8 bg-secondary_gray rounded-[20px] py-2 px-6 flex flex-col border-2 border-secondary_gray focus-within:border-primary_hover transition-all shadow-md">
								<label
									htmlFor="username"
